...
# A .yellow[kunoichi] can also use .yellow[ninpo] to .green[split rows] easily.
]]
.row.bg-main2[
.split-three[
.column[
...
# There are more ways to do these reveals.
...
--
<br>
# Enjoy the power of .yellow[ninjutsu] fellow ninja.
...
# Soon to come 
.font2[
* more explanation for sequential reveal for split cells
* explanation for easy image insertion in cells
* ninpo for animated transition slides
* shinobi theme with blue-centric colours and right overlay in title slide (hint: replace kunoichi with shinobi in the css)
* and others...
]
